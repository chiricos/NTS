 ...
 *
Template Name:  Pagina Plantas Electricas
 *
 * @file           page_plantas_electricas.php
 * @package        Responsive
 * @author         Johann Garzon
 * @copyright      2014 - ZebraStudio
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/responsive/page_plantas_electricas.php
 */
...
<div id="slider-quienes-somos">
	<div id="iconos_home">
		<div class="container">
			...
			<a href="http://www.maquinarias.com.co/" target="blank_"><div id="sem"></div></a>
		</div>
	</div>
	<div id="banner_contacto">
		<img src=" <?php bloginfo('template_url'); ?>/core/images/banner_plantas_electricas.png">
	</div>
</div>
<div id="content">
	<div id="container" class="hfeed">
		...
		<?php if ( have_posts() ) : ?>
			...
			<?php while( have_posts() ) : the_post(); ?>
				...
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="post-entry entry_equipos">
		...
		?>
		<div id="secciones_plantas_electricas">
			<a href="<?php echo home_url( '/' ); ?>equipos/plantas-electricas/doosan"><div id="doosan"></div></a>
			<a href="<?php echo home_url( '/' ); ?>equipos/plantas-electricas/perkins"><div id="perkins"></div></a>
			<a href="<?php echo home_url( '/' ); ?>equipos/plantas-electricas/cummins"><div id="cummins"></div></a>
		</div>
	</div>
