...
<div id="slider-quienes-somos">
	...
	<div id="banner_contacto">
		<img src=" <?php bloginfo('template_url'); ?>/core/images/newholand.png">
	</div>
</div>
<div id="content">
	<div id="container" class="hfeed">
		...
		<div id="secciones_newholland">
			<a href="<?php echo home_url( '/' ); ?>equipos/new-holland/cosechadoras"><div id="cosechadoras"></div></a>
			<a href="<?php echo home_url( '/' ); ?>equipos/new-holland/tractores"><div id="tractores"></div></a>
			<a href="<?php echo home_url( '/' ); ?>equipos/new-holland/implementos_agricolas"><div id="implementos_agricolas"></div></a>
		</div>
	</div>
